...
``` bash
composer require bulkmake/backpack-social-play
```
...
$this->crud->addField([
    ...
    'type' => 'new_field_name',
    'view_namespace' => 'bulkmake.backpack-social-play::fields',
]);
```
...
cp -i vendor/bulkmake/backpack-social-play/src/resources/views/fields/field_name.blade.php resources/views/vendor/backpack/crud/fields/field_name.blade.php
```
...
```bash
composer remove bulkmake/backpack-social-play
```

## Change log

Changes are documented here on Github. Please see the [Releases tab](https://github.com/bulkmake/backpack-social-play/releases).
...
If you discover any security related issues, please email info@bulkmake.com instead of using the issue tracker.

## Credits

- [Karan Datwani][link-author]
...
[ico-version]: https://img.shields.io/packagist/v/bulkmake/backpack-social-play.svg?style=flat-square
[ico-downloads]: https://img.shields.io/packagist/dt/bulkmake/backpack-social-play.svg?style=flat-square

[link-packagist]: https://packagist.org/packages/bulkmake/backpack-social-play
[link-downloads]: https://packagist.org/packages/bulkmake/backpack-social-play
